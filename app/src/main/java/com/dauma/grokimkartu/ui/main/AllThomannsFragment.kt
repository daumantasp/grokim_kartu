...
class AllThomannsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        allThomannsViewModel.viewIsReady()
        return view
    }
    ...
    private fun setupObservers() {
        allThomannsViewModel.thomannsPages.observe(viewLifecycleOwner, { thomannsPages ->
    ...
    private fun setupRecyclerView(thomannListData: List<Any>) {
        ...
        binding.allThomannsRecyclerView.adapter = ThomannListAdapter(
            ...
            loadNextPage = { this.allThomannsViewModel.loadThomannsNextPage() })
